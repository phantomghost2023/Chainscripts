...
def fetch_api_data(url: str, method: str = "GET", headers: Dict[str, str] = None,
                   params: Dict[str, Any] = None, data: Dict[str, Any] = None,
                   output_file: str = None, timeout: int = 30) -> Dict[str, Any]:
    """
...
def main():
    ...
    parser.add_argument("-H", "--header", action="append", help="HTTP header (key:value)")
    parser.add_argument("-p", "--param", action="append", help="URL parameter (key=value)")
    parser.add_argument("-d", "--data", help="Request body (JSON string)")
    parser.add_argument("-o", "--output", help="Output file path")
    parser.add_argument("--timeout", type=int, default=30, help="Request timeout")
    parser.add_argument("--hackernews", type=int, metavar="LIMIT", 
